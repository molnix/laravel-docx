...
class DocumentController extends Controller
{
    ...
    public function create_Agenda_minutes_decisions($id){
        ...
        $doc = new TemplateProcessor(public_path('documents/required_documents/Agenda_minutes_decisions.docx'));
        $doc->setValue('plot',$voting->plot_number);
        $doc->setValue('voting_day',$voting->voting_day);
    ...
    public function create_Meeting_minutes_template($id){
        $file = array('Шаблон протокола зеседания.docx','download_documents/required_documents/Шаблон протокола зеседания.docx');
        ...
        $doc = new TemplateProcessor(public_path('documents/required_documents/Meeting_minutes_template.docx'));
        $doc->setValue('plot',$voting->plot_number);
        $doc->setValue('secretary',$secretary_name);
        $doc->setValue('chairman',$chairman_name);
        $doc->setValue('vice_chairman',$vice_chairman_name);
